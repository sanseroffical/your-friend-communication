...
import { Settings, X, Eye, Type, Palette, Volume2, AlertTriangle, Accessibility, Sparkles } from 'lucide-react';
...
import { useUserSettings, THEMES, FONTS, FONT_SIZES, UserSettings } from '@/hooks/useUserSettings';
...
const SettingsPanel = ({ userId, roomCode, isAdmin }: SettingsPanelProps) => {
          ...
          <div className="fixed inset-0 bg-background/80 flex items-center justify-center z-50">
            <div className="bg-card p-6 rounded-lg max-w-sm mx-4 border border-border">
              ...
              <div className="flex gap-2">
                <Button variant="outline" onClick={() => setShowStrobeWarning(false)}>
                  Cancel
                </Button>
                <Button variant="destructive" onClick={confirmStrobeTheme}>
